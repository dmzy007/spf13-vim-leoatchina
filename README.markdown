...
```
  ...
  nnoremap <silent>=  : tabnext<CR>       #后一个标签
  nnoremap <leader>tf : tabfirst<CR>      #第一个标签
  nnoremap <Leader>tl : tablast<CR>       #皇后的标签
  nnoremap <leader>tn : tabnew<CR>        #新标签
  nnoremap <Leader>ts : tabs<CR>          #标签选择
  nnoremap <Leader>tp : tab split<CR>     #新标签中打开当前文件
  nnoremap <Leader>te : tabe<SPACE>       #新标答中打开指定文件
  nnoremap <Leader>tm : tabm<SPACE>       #移动标签
  nnoremap <silent>_  : tabm -1<CR>       #向前移动一个标签
  nnoremap <silent>+  : tabm +1<CR>       #向后移动一个标签
```
